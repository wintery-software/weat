// https://github.com/visgl/react-google-maps/blob/main/examples/autocomplete/src/hooks/use-autocomplete-suggestions.ts
...
export const useAutocompleteSuggestions = (
  ...
  useEffect(() => {
    if (!placesLib) {
      console.warn("Google Maps Places library is not loaded yet.");
